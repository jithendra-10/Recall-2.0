...
--
-- Class Contact as table recall_contact
--
...
--
-- Class Interaction as table recall_interaction
--
...
--
-- Class UserConfig as table recall_user_config
--
...
--
-- Foreign relations for "recall_interaction" table
--
ALTER TABLE ONLY "recall_interaction"
    ADD CONSTRAINT "recall_interaction_fk_0"
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('recall', '20251230175807743', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20251230175807743', "timestamp" = now();
