...
import 'package:recall_server/src/generated/chat_message.dart' as _i9;
import 'package:recall_server/src/generated/greetings/greeting.dart' as _i10;
...
class _DashboardEndpoint {
  ...
  _i3.Future<void> triggerSync(_i1.TestSessionBuilder sessionBuilder) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'dashboard',
...
class _DebugEndpoint {
  ...
  _i3.Future<String> seedTestData(_i1.TestSessionBuilder sessionBuilder) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'debug',
  ...
  _i3.Future<String> clearTestData(
    _i1.TestSessionBuilder sessionBuilder,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
...
class _RecallEndpoint {
  ...
  _i3.Future<_i9.ChatMessage> askRecall(
    _i1.TestSessionBuilder sessionBuilder,
    String query,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
