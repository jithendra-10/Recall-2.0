...
import 'package:recall_client/src/protocol/chat_message.dart' as _i9;
import 'package:recall_client/src/protocol/greetings/greeting.dart' as _i10;
...
class EndpointRecall extends _i2.EndpointRef {
  ...
  _i3.Future<_i9.ChatMessage> askRecall(String query) =>
      caller.callServerEndpoint<_i9.ChatMessage>(
        'recall',
        'askRecall',
        {'query': query},
      );
